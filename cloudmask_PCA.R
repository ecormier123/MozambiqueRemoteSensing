...
for (ii in 1:length(sat.images)){
  ...
  in.folder = "D:/preprocessoutputcloudy"
  ...
  if (sat.images.list[ii] == "L5_TM_2005_06_27_15_31_27_014042_L2R.nc.tif") {
    ...
    write.data = paste("D:/preprocessoutput/L5_TM_2005_06_27_15_31_27_014042_L2R.nc")
    ...
    write.data = paste("D:/preprocessoutput/L7_ETM_2001_04_05_15_33_53_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L5_TM_2008_07_21_15_30_30_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L8_OLI_2013_03_20_15_44_46_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L5_TM_2009_02_14_15_29_42_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L5_TM_2009_07_24_15_32_50_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L5_TM_2011_02_20_15_33_49_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L5_TM_2011_07_14_15_32_59_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L8_OLI_2015_02_15_15_43_39_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L8_OLI_2016_09_29_15_44_04_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L8_OLI_2017_02_04_15_43_51_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L8_OLI_2018_10_21_15_43_43_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L8_OLI_2019_06_02_15_43_35_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
    ...
    dat.stack = subset(dat.stack,order(c(1,2,3,4,5,7,6)))
    names(dat.stack) = c("blue","green","red","lyzgr","lyzgrbl","pca1", "depth")
    write.data = paste("D:/preprocessoutput/L9_OLI_2022_05_01_15_43_35_014042_L2R.nc")
    writeRaster(dat.stack, write.data, format="GTiff",NAflag = NaN, overwrite=T)
